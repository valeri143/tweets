...
`,Un=()=>{const[e,t]=F.useState([]),[n,r]=F.useState([]),[s,o]=F.useState(1),[i,l]=F.useState(!0),[p,d]=F.useState(!1),[c,h]=F.useState("show all"),x=Je();F.useEffect(()=>{(async()=>{d(!0);try{const b=await fn(s);t(s!==1?S=>[...S,...b]:b),l(b.length!==0&&s!==4)}catch(b){console.log(b)}finally{d(!1)}})()},[s]),F.useEffect(()=>{let f,b;switch(c){case"show all":r(e);break;case"follow":b=e.filter(S=>localStorage.getItem(`isFollowing_${S.id}`)!=="true"),r(b);break;case"followings":f=e.filter(S=>localStorage.getItem(`isFollowing_${S.id}`)==="true"),r(f);break}},[e,c]);const g=()=>{o(f=>f+1)},u=f=>{h(f.target.value)};return w.jsxs(w.Fragment,{children:[w.jsx(Ve,{children:"Tweets"}),w.jsxs(se,{type:"button",onClick:()=>x("/"),children:[w.jsx(Fn,{width:"20",height:"20",children:w.jsx("use",{href:`${Ee}#icon-arrow-left`})}),"Back"]}),w.jsxs(Nn,{value:c,onChange:u,children:[w.jsx(Z,{value:"show all",children:"Show All"}),w.jsx(Z,{value:"follow",children:"Follow"}),w.jsx(Z,{value:"followings",children:"Followings"})]}),w.jsxs(Tn,{children:[n.length===0&&c==="followings"&&w.jsxs(w.Fragment,{children:[w.jsx("p",{children:"No followings yet "}),w.jsx("p",{children:"It`s time to follow someone!"})]}),w.jsx(Cn,{children:n.length!==0&&n.map(f=>w.jsx("li",{children:w.jsx(An,{cardId:f.id,tweets:f.tweets,followers:f.followers,avatar:f.avatar,setUsers:t})},f.id))}),p&&w.jsx("p",{children:"Loading..."}),i&&c==="show all"&&w.jsx(ze,{type:"button",onClick:g,children:"Load More"})]})]})};export{Un as default};
